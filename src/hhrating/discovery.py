...
_LIST_WORDS = ("公司", "集团", "银行", "学校", "医院", "政府", "推荐", "必吃", "名单",
               ...
               "地图", "测评", "哪家", "评价最高", "怎么样", "好不好", "好吃", "哪些",
               "最好", "十家", "文库", "知乎", "点评网", "反馈", "有什么", "无内容",
               "一览", "天梯", "品牌网", "问问", "最火")
_REJECT_RE = re.compile(
    r"哪些|好吃|最好|十家|文库|知乎|点评网|反馈|有什么|无内容|一览|天梯|品牌网|"
    r"问问|大全|攻略|榜单|排行|盘点|指南|地图|排名|合集|测评|隶属于|源自|公认的|"
    r"著名|国民|无人不知|最朴素|必吃榜|老字号饭店是| snack|前身"
)
    ...
    for line in cleaned.splitlines():
        ...
        for m in _NAME_RE.finditer(line):
            ...
            if len(name) < 3 or len(name) > 20:
                continue
            if _REJECT_RE.search(name) or any(w in name for w in _LIST_WORDS):
                continue
